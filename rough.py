...
# read image l
l = iio.imread('/home/varun/sr/datasets/practice/0813_30.png') # 0813_5
l = np.asarray(l)
l = l / 255
...
pl = PerceptualLoss(feature_layer=7).to('cuda')

# L1 loss
print(f'Perceptual loss with psnr 44 : {pl(b.float(), h.float()).item()}')
print(f'Perceptual loss with psnr 5 : {pl(b.float(), l.float()).item()}')
